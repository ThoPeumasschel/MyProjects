	...
	//			pt.angarr[pt.iangarr] = 
			...
			case 3: {
				...
				pt.angarr[pt.iangarr++] = new Angestellter("Capone", "Al", "Gangsters Paradise 1", "01/123345213",
						5000000);
				pt.angarr[pt.iangarr++] = new Angestellter("Guzmán", "Joaquín", "Jiquilpan Boulevard 1002",
						"052/777777", 75000000);
				pt.angarr[pt.iangarr++] = new Angestellter("Escobar", "Pablo", "Hacienda Nápoles 1", "057/666666",
						100000000);

				if (pt.iangarr > 29) {
					System.out.println("Array für Angestellte voll!");
				}
			...
			case 4: {
				...
				if (pt.iarbarr > 29) {
					System.out.println("Array für Arbeiter voll!");
				}
