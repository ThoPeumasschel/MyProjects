...
public class Aussen
{
	...
	//*******************************************************************************************************************
	//elementklasse:  -> Eine Elementklasse ist implizit nichts anderes, als ein Attribut der äusseren Klasse!
	public class Innen 
	{
		...
		public Innen()
		{
			zahl=12; //hier wird das attrinut der INNEREN klasse und nicht das der äusseren initialisiert! 
			Aussen.this.zahl=300; //hier wird explizit das gleichnamige attribut der äusseren klasse initialsiert!
			innen=this;
			text="Text"; //innere elementklassen können ohne weiteres auf alle attribute der äusseren direkt zugreifen!
			macheEtwasAussen();
		}
	 ...
	 * 	Regeln:
	 * 
	 * 		-> Für Methodenklassen sind Sichtbarkeitsmodifikatoren verboten
	 * 		-> Auch in static-Methoden darf es Methodenklassen geben!
	 * 		-> Methodenklassen können andere Klassen erweitern und auch Interfaces implementieren
	 * 		-> Aus der lokalen Klasse heraus kann man auf alle Elemente der äusseren Klasse zugreifen
	 * 		-> Zugriff aus der lokalen Klasse heraus auf lokale Variablen nur erlaubt, wenn diese final sind!
	 * 		-> In einer Methode kann es beliebig viele lokale Klassen geben, welche auch voneinander(sequentiell) erben können!
	 * 
	 * 
	 */
	...
	public void ausgabe()
	{
		...
		//erst ab hier kann man von der Methodenklasse Objekte erzeugen!! (erst ab hier ist sie komplett ausgelesen und bekannt!)
