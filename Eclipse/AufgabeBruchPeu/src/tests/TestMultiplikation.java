...
public class TestMultiplikation
{
	Model m = new Model();
	@Test
	public void testMultiplikationVerschNenner()
	{
		// Testbrüche mit zu erwartendem Ergebnis instanziieren
		// 1. Test: Vorzeichen + und +
		Bruch b1 = new Bruch(1, 4, 16, "+");
		Bruch b2 = new Bruch(0, 1, 4, "+");
		Bruch b3 = new Bruch();
		Bruch erg1 = new Bruch(0, 5, 16, "+");
